...
public class PointsRemoveHandler extends BaseCommandHandler<UnitedSkills> {

    public PointsRemoveHandler(UnitedSkills plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        Messenger.sendMessage(sender, messageProvider.get("messages.points-removed"),
